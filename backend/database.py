...
class Database:
    ...
    def _create_indexes(self, conn):
        ...
        conn.execute("CREATE INDEX IF NOT EXISTS idx_knowledge_source ON knowledge(source)")
        conn.execute("CREATE INDEX IF NOT EXISTS idx_embeddings_knowledge_id ON embeddings(knowledge_id)")
        conn.execute("CREATE INDEX IF NOT EXISTS idx_research_sessions_user_id ON research_sessions(user_id)")
